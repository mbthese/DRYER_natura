...
## Figure S1: The seven selected species’ phylogeny.
...
##Figure S2: The map of the collected seedlings

*map constructed with QGIS 3.16 Hannover*

##Figure S3:  Sampling design. 

*figure drawn using Biorender.com*

##Figure S4: Seedling dimensions. 
...
##Figure S5 : Total contribution of variables to PCA axes 1, 2, 3 and 4.
...
#contributions
res <- PCA(Data_PCA[,-1], scale.unit = TRUE)
...
contri <- ggarrange(contri_1, contri_2, contri_3, contri_4, labels = c("A", "B", "C", "D"), ncol=2, nrow=2, common.legend = T, legend = "bottom")

ggsave(filename = "contributionPCA.png", plot = contri, bg = "white", width = 12, height = 8, dpi = 600)
```

##Figure S6: Major bacterial phyla detected in the roots and leaves of the seven tropical tree seedlings.
...
##Figure S7: Top 20 bacterial orders detected in the roots and leaves of the seven tropical tree seedlings.
...
##Figure S8: Major fungal phyla detected in the roots and leaves of the seven tropical tree seedlings.
...
##Figure S9: Top 20 fungal orders detected in the roots and leaves of the seven tropical tree seedlings.
...
##Figure S10: Alpha diversity of seven tropical tree seedlings.
...
##Table S1 : Description of the bacterial and fungal endophyte dataset. Number of replicates, means number of reads and OTUs per replicate per species.
...
##Table S2. Soil composition of SF soils in Paracou station where seedlings were collected.
